...
const Sidebar = ({ isOpen = false, onClose }) => {
  ...
  const navSections = {
    Overview: [
      ...
      { to: '/dashboard/faculty-portal', label: 'Faculty Portal', icon: '🎓', perm: 'VIEW_FACULTY_PORTAL' },
    ],
    Academic: [
      ...
      { to: '/dashboard/faculty', label: 'Faculty', icon: '👩‍🏫', perm: 'VIEW_FACULTY', adminOnly: true },
    ...
    Campus: [
      ...
      { to: '/dashboard/hostel', label: 'Hostel', icon: '🏠', perm: 'VIEW_HOSTEL', end: true },
      ...
      { to: '/dashboard/book-requests', label: 'Book Requests', icon: '📚', perm: 'VIEW_FACULTY' },
    ...
    Admin: [
      ...
      { to: '/dashboard/roles', label: 'Role Management', icon: '🔑', perm: 'VIEW_ROLE', adminOnly: true },
      { to: '/dashboard/employees', label: 'Employees', icon: '👨‍💼', perm: 'VIEW_EMPLOYEE' },
      { to: '/dashboard/payroll', label: 'Payroll', icon: '💸', perm: 'VIEW_PAYROLL' },
      { to: '/dashboard/leaves', label: 'Leave Approvals', icon: '📅', perm: 'VIEW_LEAVE', adminOnly: true },
      { to: '/dashboard/workload', label: 'Faculty Workload', icon: '👨‍🏫', perm: 'VIEW_WORKLOAD', adminOnly: true },
      { to: '/dashboard/student-affairs', label: 'Student Affairs', icon: '🎓', perm: 'VIEW_STUDENT', adminOnly: true },
      { to: '/dashboard/events', label: 'Events', icon: '🎪', perm: 'VIEW_EVENT' },
      { to: '/dashboard/clubs', label: 'Clubs & Societies', icon: '👥', perm: 'VIEW_CLUB' },
      { to: '/dashboard/reports', label: 'Reports', icon: '📊', perm: 'VIEW_REPORT', adminOnly: true },
      { to: '/dashboard/audit', label: 'Audit Log', icon: '🗒️', perm: 'VIEW_AUDIT', adminOnly: true },
      { to: '/dashboard/settings', label: 'Settings', icon: '⚙️', perm: 'VIEW_SETTINGS', adminOnly: true },
    ],
    'Campus Life': [
