...
const FacultyImportModal = ({ isOpen, onClose, onImported }) => {
    ...
    return (
        ...
        >
            <div>
                ...
                {result && (
                    <div style={{ padding: '20px', marginBottom: '20px', background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '15px' }}>
                            ...
                            <div style={{ padding: '15px', background: result.failed > 0 ? '#fef2f2' : '#f0fdf4', borderRadius: '8px', border: result.failed > 0 ? '1px solid #fca5a5' : '1px solid #bbf7d0', textAlign: 'center' }}>
                ...
                <div
                    ...
                    style={{
                        border: '2px dashed #cbd5e0', borderRadius: '12px', padding: '30px', textAlign: 'center',
                ...
                {preview && (
                    <div style={{ marginTop: '20px' }}>
                        <h4>Preview ({preview.totalRows} rows)</h4>
                ...
                <div style={{ marginTop: '20px', paddingTop: '15px', borderTop: '1px solid #e2e8f0' }}>
                    <h4 style={{ margin: '0 0 8px', color: '#666' }}>CSV Format</h4>
                    <ul style={{ color: '#4a5568', fontSize: '0.9rem', margin: 0, paddingLeft: '20px' }}>
                        <li><strong>Required:</strong> Name, Email</li>
                        <li><strong>Optional:</strong> Phone, Department, Qualification, Specialization, Password</li>
                    </ul>
                </div>
            </div>
        </Modal>
