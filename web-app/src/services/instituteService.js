...
export const updateUserRole = (id, roleId) => api.put(`/users/${id}/role`, { roleId });
export const updateUserSecondaryRoles = (id, roleIds) => api.put(`/users/${id}/secondary-roles`, { roleIds });
