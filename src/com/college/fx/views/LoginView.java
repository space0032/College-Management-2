...
public class LoginView {
    ...
    private void createView() {
        ...
        roleComboBox.getItems().addAll("ADMIN", "FACULTY", "STUDENT", "WARDEN");
        ...
        loginButton.setOnMouseEntered(e -> 
            loginButton.setStyle(loginButton.getStyle().replace("#14b8a6", "#0d9488"))
        );
        loginButton.setOnMouseExited(e -> 
            loginButton.setStyle(loginButton.getStyle().replace("#0d9488", "#14b8a6"))
        );
    ...
    private void handleLogin() {
        ...
        if (userId > 0) {
            ...
            // Log login
            com.college.dao.AuditLogDAO.logAction(userId, username, "LOGIN", "USER", userId, "User logged in as " + role);
